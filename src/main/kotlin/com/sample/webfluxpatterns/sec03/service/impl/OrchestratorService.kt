...
import com.sample.webfluxpatterns.sec03.util.DebugUtil
import com.sample.webfluxpatterns.sec03.util.OrchestratorUtil
...
class OrchestratorService(
    ...
    fun placeOrder(mono: Mono<OrderRequest>): Mono<OrderResponse> {
        return mono
            ...
            .flatMap { getProduct(it) }
            .doOnNext { OrchestratorUtil.buildRequestContext(it) }
